...
private:
    ...
    void currentPositionCallback(const nav_msgs::Odometry::ConstPtr &msg)
    {
        ...
        current_position_.pose.position.x = msg->pose.pose.position.x;
        current_position_.pose.position.y = msg->pose.pose.position.y;
        current_position_.pose.position.z = msg->pose.pose.position.z;
    }

    void computeDifference()
    {
        diff_position_ = current_position_; // copy the current config
